...
?>
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control" placeholder="E.g.: Test File"  value = "<?php if(isset($_POST['upload'])) {
            echo $file_title; } ?>" required="">
	</div>

	<div class="form-group">
		<label for="post_tags">Short Description</label>
		<input type="text" name="description" class="form-control" placeholder="E.g.: Test File includes basic questions ...." value="<?php if(isset($_POST['upload'])) {
